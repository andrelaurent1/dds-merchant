      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          ...
          case StorePaymentTypeViewRow:
            return StorePaymentTypeViewRow(data);
          case PaylaterContractItemViewRow:
            return PaylaterContractItemViewRow(data);
          case PaylaterAccountViewRow:
            return PaylaterAccountViewRow(data);
          case UserViewRow:
            return UserViewRow(data);
          case PaylaterContractViewRow:
