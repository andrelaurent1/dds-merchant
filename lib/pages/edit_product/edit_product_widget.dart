...
class _EditProductWidgetState extends State<EditProductWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      setState(() {
        _model.imageUrl = widget.product?.imageUrl;
        _model.isImageUpdated = false;
      });
    });
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: FFButtonWidget(
                onPressed: () async {
                  if (_model.isImageUpdated == true) {
                    _model.updatedProductWithNewImage =
                    ...
                    if (widget.product?.imageUrl ==
                      ...
                      _model.updatedProductWithoutImage =
                          await ProductCommandTable().insert({
                        'price': double.tryParse(_model.textController2.text),
                        'description': _model.textController1.text,
                        'op': 'UPDATE',
