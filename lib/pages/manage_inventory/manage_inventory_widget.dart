...
import 'manage_inventory_model.dart';
export 'manage_inventory_model.dart';

class ManageInventoryWidget extends StatefulWidget {
  const ManageInventoryWidget({
    Key? key,
  ...
  @override
  _ManageInventoryWidgetState createState() => _ManageInventoryWidgetState();
}

class _ManageInventoryWidgetState extends State<ManageInventoryWidget>
    with TickerProviderStateMixin {
  late ManageInventoryModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ManageInventoryModel());
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  context.pushNamed(
                                    'ManageInventoryForms',
                                    queryParameters: {
                                      'stockUpdateReason': serializeParam(
